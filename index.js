...
const unfundedGamesText = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length.toString()} games. Currently, ${unfundedGamesCount} games remain unfunded.  
...
// Append the first game element to the correct container
...
// Append the second game element to the correct container
